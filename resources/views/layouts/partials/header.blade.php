  ...
  <header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        <button type="button" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default hidden-xs" data-toggle="popover" data-trigger="click" data-html="true" data-placement="bottom">
          <a href="{{url('/send_sms')}}" class="nav-link">
            <strong><i class="fa fa-calculator fa-lg" aria-hidden="true">&nbsp Send SMS</i></strong>
          </a>
        </button>
